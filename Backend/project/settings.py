...
SECRET_KEY = "django-insecure-gv=0y4iwus!jmjhpih4mc$zricx&e0_^)zsp@3-37gk6(8(c9y"
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=60),  # example token lifetime
}
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {
            "name": "Repo",
            "url": "https://github.com/hassaneldash/Final_Project-Python-R2-Minya-ICC44-ITI",
            "new_window": True,
        },
        {"app": "cart", "label": "cart"},
